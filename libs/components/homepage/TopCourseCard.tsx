...
const TopPropertyCard = (props: TopCourseCardProps) => {
				...
				>
					<div className="flex flex-row items-center mb-2 justify-between">
						<p
							...
							className="flex items-center text-sm font-openSans font-semibold text-slate-950 dark:text-slate-200 hover:underline"
						>
							{course?.courseTitle
					...
					<p className="font-openSans text-sm font-normal text-gray-600">
						{course?.courseDesc
